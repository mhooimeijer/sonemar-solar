			...
			<div class="col-lg-7">
				...
				<div class="hero-content">
					...
					<div class="hero-content-body wow fadeInUp" data-wow-delay="0.5s">
						<p>Sonemar Solar provides reliable, cost-efficient solar solutions for homes and businesses across the Philippines. Take control of your energy costs and switch to a smarter, more sustainable power source.</p>
					</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6">
				...
				<div class="about-content wow fadeInUp" data-wow-delay="0.25s">
					<p>Sonemar Solar is a Philippine-based renewable energy company committed to making solar power accessible, affordable, and reliable.</p>
					<p>We design and install customized solar systems for residential, commercial, and industrial clients—helping reduce electricity costs while promoting a cleaner, more sustainable future.</p>
					<p>Our team combines technical expertise with local market knowledge to deliver solutions that work in real-world conditions across the Philippines.</p>
					<ul>
					...
					<div class="swiper">
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide">
								<div class="service-item"  style="background-image: url(images/Solar-Panel-Materials.jpg); background-size: cover; background-position: center; min-height: 500px;">
									...
									<div class="service-content">
										...
										<p>Ensure your solar system operates at peak performance with our professional maintenance and inspection services.</p>
									</div>
								</div>
							</div>
							<!-- Service Slide End -->
							...
							<!-- Service Slide Start -->
							<div class="swiper-slide">
								<div class="service-item" style="background-image: url(images/project-management.avif); background-size: cover; background-position: center; min-height: 500px;">
									<div class="service-image">
										<figure>
			...
			<div class="col-md-4">
				...
				<div class="step-item step-1 wow fadeInUp" data-wow-delay="0.25s">
					...
					<div class="step-content">
						...
						<p>We evaluate your energy usage, location, and goals to design the best solar solution for your needs. We evaluate financing options.</p>
					</div>
				</div>
				<!-- Step Item End -->
			</div>
			...
			<div class="col-md-4">
				...
				<div class="step-item step-2 wow fadeInUp" data-wow-delay="0.5s">
					...
					<div class="step-content">
						...
						<p>Our team conducts a detailed technical assessment to ensure maximum efficiency and return on investment and builds the financing solution.</p>
					</div>
				</div>
				<!-- Step Item End -->
			</div>
			...
			<div class="col-md-4">
				...
				<div class="step-item wow fadeInUp" data-wow-delay="0.75s">
					...
					<div class="step-content">
						...
						<p>We install your system safely and efficiently, ensuring long-term performance and reliability.</p>
					</div>
				</div>
				<!-- Step Item End -->
			</div>
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<div class="section-title">
					...
					<p class="wow fadeInUp" data-wow-delay="0.25s">We use high-quality components and proven technologies to deliver efficient, long-lasting solar systems that maximize your energy production and savings.</p>
				</div>
				<!-- Section Title End -->
			</div>
						...
						<div class="col-lg-8">
							...
							<div class="cta-content">
								...
								<p class="wow fadeInUp" data-wow-delay="0.25s">Have Questions? Let’s Talk Solar.
									...
									Thinking about switching to solar? Our team is ready to guide you every step of the way—from consultation to installation.</p>
							</div>
							<!-- CTA Content End -->
						</div>
					</div>
			...
			<div class="col-lg-3 col-md-6">
				...
				<div class="why-choose-item wow fadeInUp" data-wow-delay="1.0s">
					...
					<div class="why-choose-content">
						...
						<p>With a combined 50 years of managing projects in the Energy sector, we have a proven track record of delivering successful projects.</p>
					</div>
				</div>
				<!-- Why Choose Item End -->
			</div>
