...
<head>
	...
	<!-- Page Title -->
	<title>Sonemar - Solar & Renewable Energy</title>
	<!-- Favicon Icon -->
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="topbar-contact-info">
						<ul>
							<li><a href="#"><i class="fa-solid fa-envelope"></i> info@sonemar-solar.com</a></li>
							<li><a href="#"><i class="fa-solid fa-phone"></i> +63 908 773 8794</a></li>
						</ul>
					</div>
					...
					<div class="collapse navbar-collapse main-menu">
						<ul class="navbar-nav mr-auto" id="menu">
							<li class="nav-item submenu"><a class="nav-link" href="./">Home</a>
								<ul>
									<li class="nav-item"><a class="nav-link" href="index.php">Home 01 - Image</a></li>
									<li class="nav-item"><a class="nav-link" href="index_1.html">Home 01 - Video</a></li>
									<li class="nav-item"><a class="nav-link" href="index-slider.html">Home 01 - Slider</a></li>
									<li class="nav-item"><a class="nav-link" href="index-2.html">Home 02 - Image</a></li>
									<li class="nav-item"><a class="nav-link" href="index-2-video.html">Home 02 - Video</a></li>
									<li class="nav-item"><a class="nav-link" href="index-2-slider.html">Home 02 - Slider</a></li>
									<li class="nav-item"><a class="nav-link" href="index-3.html">Home 03 - Image</a></li>
									<li class="nav-item"><a class="nav-link" href="index-3-video.html">Home 03 - Video</a></li>
									<li class="nav-item"><a class="nav-link" href="index-3-slider.html">Home 03 - Slider</a></li>
								</ul>
							</li>
							...
							<li class="nav-item submenu"><a class="nav-link" href="#">Pages</a>
								<ul>
									...
									<li class="nav-item"><a class="nav-link" href="old/404.html">404</a></li>
								</ul>
							</li>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="section-title">
						...
						<h2 class="text-anime">Words From Our Customer</h2>
					</div>
					<!-- Section Title End -->
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="section-title">
						...
						<h2 class="text-anime">Our Best Experts</h2>
					</div>
					<!-- Section Title End -->
				</div>
			</div>
